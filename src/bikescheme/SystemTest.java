...
public class SystemTest {
    ...
    public void hireBike() {
        ...
        // Interleave input and expected output events so that sequence 
        // matches that when describing the use case main success scenario.
        logger.info("hireBike");
        
        input ("2 08:00, KeyReader, B.2.kr, insertKey, key-2");
        expect("2 08:00, BikeLock, B.2.bl, unlocked");
        expect("2 08:00, OKLight,   B.2.ok, flashed");
    ...
    public void returnBike() {
        ...
        // Interleave input and expected output events so that sequence 
        // matches that when describing the use case main success scenario.
        logger.info("returnBike");
        
        input ("2 08:00, BikeSensor, B.2.bs, dockBike, bike-2");
        expect("2 08:00, BikeLock, B.2.bl, locked");
        expect("2 08:00, OKLight,   B.2.ok, flashed");
   ...
   /** @Test
    public void addDStation() {
        ...
        // Interleave input and expected output events so that sequence 
        // matches that when describing the use case main success scenario.
        logger.info("addDStation");
        
        input("1 07:00, HubTerminal, ht, addDStation,C,   100,   100, 7");
  ...
  /**  @Test
    public void viewUserActivity() {
        ...
        input("2 18:00, DSTouchScreen, B.2.ts, viewActivity");
        expect("2 18:00, DSTouchScreen, B.2.ts, viewPrompt");
   ...
   */ //commented out for HireBike functionality of BikeLock
